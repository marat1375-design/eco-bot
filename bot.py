...
def normalize_query(query):
    ...
    replacements = {
        ...
        "огнетушителя нет": "отсутствие огнетушителя пожарная безопасность первичные средства пожаротушения",
        "нет огнетушителя": "отсутствие огнетушителя пожарная безопасность первичные средства пожаротушения",
...
print("БОТ ЗАПУЩЕН - нормативный помощник проверки ПККР + adilet.zan.kz + Gemini + pyTelegramBotAPI")
